        ...
        try:
            ...
            completion = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": st.session_state['conversation'][-1]['content']}
                ]
            )
            ...
            print(StringData)
            df = pd.read_csv(StringData, sep=",", on_bad_lines='skip')
            ...
            # Optional: Wait a moment before retrying, e.g., time.sleep(1)

    if not success:
        st.error("Failed to generate the table after 3 attempts.")
